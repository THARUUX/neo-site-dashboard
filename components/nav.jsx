...
export default function Nav({show}) {
  ...
  const activeLink = 'flex gap-1 p-1 gap-3 text-xl items-center px-5 bg-white text-lime-900 rounded-lg py-2';
  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-slate-400 min-h-full md:static md:w-auto transition-all"}>
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link href={'/ms'} className={pathname.includes('/ms') ? activeLink : inactiveLink}>
